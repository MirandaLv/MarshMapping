...
if __name__ == "__main__":
    ...
    conf = OmegaConf.load("./config_hlbinary.yaml")
    ...
    for (model, encoder) in itertools.product(
            model_options,
            encoder_options):
        
        
        model_kwargs['arch'] = model
        experiment_name = f"{model}_{encoder}_0.0001"
        ...
        early_stopping_callback = EarlyStopping(monitor='valid_dataset_iou', min_delta=0.00, patience=5, mode='max')
